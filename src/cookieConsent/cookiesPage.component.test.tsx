  ...
  beforeEach(() => {
    ...
    props = {
      ...
      classes: {
        ...
        titleText: 'title-text-class',
        cookiePolicy: 'cookie-policy-class',
        cookieTypes: 'cookie-types-class',
        button: 'button-class',
        cookieList: 'cookie-list-class',
        cookieListItem: 'cookie-list-item-class',
      },
    };
  });
